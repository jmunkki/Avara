...
void	CWeapon::Explode()
{
	...
	itsDepot->FireSlivers(15, location, temp,
							partList[0]->bigRadius >> 2,
							blastPower << 1,
							160,
							20,
							0,
