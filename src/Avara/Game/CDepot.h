/*
    ...
    File: CDepot.h
    Created: Wednesday, March 8, 1995, 6:00
...
public:
	...
	virtual	void				FireSlivers(short n, Fixed *origin, Fixed *direction, Fixed scale,
								Fixed speedFactor, short spread, short age, short sizeGroup,
								CBSPPart *fromObject);
	...
	virtual	CAbstractMissile *	LaunchMissile(short kind, Matrix *startMatrix, RayHitRecord	*target,
									CAbstractActor *theOwner, Fixed energy, Fixed *speedVector);
