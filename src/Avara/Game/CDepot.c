	...
	CBSPPart *fromObject)
{
	...
	{	
		...
		vp = itsGame->itsView;
		VectorMatrix34Product(1, (Vector *)origin, (Vector *)loc, &vp->viewMatrix);
...
CAbstractMissile *	CDepot::MakeMissile(
	short	kind)
{
...
CAbstractMissile *CDepot::LaunchMissile(
	short			kind,
	Matrix			*startMatrix,
	RayHitRecord	*target,
