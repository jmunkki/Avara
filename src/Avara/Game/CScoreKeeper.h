...
public:
	class	CAvaraGame				*itsGame;
			ScoreInterfaceRecord	interface;
	...
	virtual	void			Score(ScoreInterfaceReasons reason, short team, short player,
									long points, Fixed energy, short hitTeam, short hitPlayer);
