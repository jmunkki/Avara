	...
	long tag)
{
	...
	if(index >= 0)
	{
		...
		if(theHandle)
		{
			BlockMoveData(((TagDataBlock *)(offset + *tagBaseBlocks))->data,
						*theHandle,
						len);
		}
	}
